...
public class ExcelUtilities {
    ...
    public static Map<String,String> getColumnData(String file,String sheetName) throws IOException {
    ...
    public static Map<String,String> getRowData(String file,String sheetName, String row) throws IOException {
